    ...
    (a.modules = {
          ...
          let {
            ...
            j = (function (a, b, c, d, f) {
              ...
              [c, null])) {
                ...
                if (k && f) {
                  if (
                    k.url.pathname === a.pathname &&
                    k.url.search !== a.search
                  )
                    return { ...k, aliased: !0 };
                  return k;
                }
      ...
      967: (a, b, c) => {
        ...
        function g() {
          return (0, d.jsxs)("div", {
            className:
              "grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] font-bold text-4xl",
            children: [
              (0, d.jsx)("p", { children: "Log-in Page" }),
              (0, d.jsx)(f(), {
                href: "/dashboard",
      ...
      1808: (a, b, c) => {
        ...
        function k(a, b, c, d, e, j, k, n, o, p) {
          return !e &&
            (void 0 === b || (0, g.isNavigatingToNewRootLayout)(b, c))
            ? i
                  ...
                  G.then(
                    (m) => {
                      ...
                      if (
                        ...
                        let e = (0, s.handleAliasedPrefetchEntry)(
                          z,
                          b,
                          q,
                          d,
                      ...
                      for (let a of q) {
                        ...
                        if (
                          (null === y &&
                            (y = (0, g.applyRouterStatePatchToTree)(
                              w,
                              F,
                              s,
                              C,
            ...
            R = {
              ...
              onMouseEnter(a) {
                (F || "function" != typeof D || D(a),
                  ...
                  K &&
                    L &&
                    (0, l.onNavigationIntent)(a.currentTarget, !0 === I));
              },
      ...
      6067: (a, b, c) => {
        Promise.resolve().then(c.t.bind(c, 5169, 23));
      },
      6134: () => {},
      6143: (a, b, c) => {
        "use strict";
            ...
            get: function () {
              return function a(b, c, d, i) {
                ...
                if (2 === b.length) j = h(l[q], d);
                  ...
                  null ===
                  (j = a((0, e.getNextFlightSegmentPath)(b), l[q], d, i))
                )
                  return null;
                let r = [b[0], { ...l, [q]: j }, m, n];
                return (
        ...
        let H = [
            "",
            {
              children: [
                ...
                {
                  page: [
                    () => Promise.resolve().then(c.bind(c, 967)),
                    "C:\\Users\\prana\\code\\Sure-Walk\\apps\\web\\src\\app\\page.tsx",
                  ],
                },
              ],
            },
            {
              layout: [
                ...
                "C:\\Users\\prana\\code\\Sure-Walk\\apps\\web\\src\\app\\layout.tsx",
              ],
              "global-error": [
                () => Promise.resolve().then(c.t.bind(c, 1170, 23)),
              ...
              m = async ({ span: e, postponed: f, fallbackRouteParams: g }) => {
                let i = {
                    ...
                    renderOpts: {
                      ...
                      dir: c(9902).join(process.cwd(), K.relativeProjectDir),
                      isDraftMode: _,
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
        ...
        function g(a) {
          ...
          return (
            (0, d.useEffect)(() => {
              ...
              (void 0 !== j.current && j.current !== a && i(a),
                (j.current = a));
            }, [b]),
      ...
      8151: (a, b, c) => {
        ...
        let d = c(1054),
          ...
          f = c(3754),
          g = (a) =>
            "string" == typeof a ? ("children" === a ? "" : a) : a[1];
        function h(a) {
          return (
            a.reduce((a, b) => {
              let c;
            ...
            if (q) {
              if (l && (!v || !v.lazyData || v === u)) {
                ...
                ((v = {
                  ...
                  loading: f,
                  parallelRoutes:
                    j && u ? new Map(u.parallelRoutes) : new Map(),
                  navigatedAt: a,
                }),
                  u && j && (0, d.invalidateCacheByRouterState)(v, u, m),
                  j &&
                    (0, e.fillLazyItemsTillLeafWithHead)(a, v, u, m, l, n, i),
                  t.set(r, v));
              }
              continue;
            }
