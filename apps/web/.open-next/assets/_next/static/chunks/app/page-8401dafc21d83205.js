(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    ...
    2619: (e, t, r) => {
      ...
      function g(e) {
        ...
        let r,
          n,
          i,
          [g, b] = (0, u.useOptimistic)(f.IDLE_LINK_STATUS),
          P = (0, u.useRef)(null),
          {
            href: _,
            as: v,
        ...
        let B = M ? n && "object" == typeof n && n.ref : L,
          z = u.default.useCallback(
            (e) => (
              null !== U &&
                (P.current = (0, f.mountLinkInstance)(e, D, U, F, w, b)),
              () => {
                (P.current &&
                  ((0, f.unmountLinkForCurrentNavigation)(P.current),
                  (P.current = null)),
          ...
          Q = {
            ...
            onMouseEnter(e) {
              (M || "function" != typeof x || x(e),
                ...
                U && w && (0, f.onNavigationIntent)(e.currentTarget, !0 === k));
            },
        ...
        return (
          (0, c.isAbsoluteUrl)(K)
            ...
            : (M && !j && ("a" !== n.type || "href" in n.props)) ||
              (Q.href = (0, s.addBasePath)(K)),
          (i = M
            ? u.default.cloneElement(n, Q)
            : (0, o.jsx)("a", { ...I, ...Q, children: r })),
          (0, o.jsx)(m.Provider, { value: g, children: i })
        );
      }
      let m = (0, u.createContext)(f.IDLE_LINK_STATUS),
        b = () => (0, u.useContext)(m);
  ...
  (e) => {
    (e.O(0, [441, 255, 358], () => e((e.s = 9749))), (_N_E = e.O()));
  },
]);
